...
class ItemTagsProvider(output: FabricPackOutput, registriesFuture: CompletableFuture<HolderLookup.Provider>) : FabricTagsProvider.ItemTagsProvider(output, registriesFuture) {
    override fun addTags(p0: HolderLookup.Provider) {
        ...
        valueLookupBuilder(TwilightItemTags.TWILIGHT_OAK_LOGS_ITEM_TAG.tagKey)
        ...
        valueLookupBuilder(TwilightItemTags.CANOPY_LOGS_ITEM_TAG.tagKey)
        ...
        valueLookupBuilder(TwilightItemTags.TWILIGHT_MANGROVE_LOGS_ITEM_TAG.tagKey)
        ...
        valueLookupBuilder(TwilightItemTags.DARKWOOD_LOGS_ITEM_TAG.tagKey)
        ...
        valueLookupBuilder(TwilightItemTags.TIMEWOOD_LOGS_ITEM_TAG.tagKey)
        ...
        valueLookupBuilder(TwilightItemTags.TRANSWOOD_LOGS_ITEM_TAG.tagKey)
        ...
        valueLookupBuilder(TwilightItemTags.MINEWOOD_LOGS_ITEM_TAG.tagKey)
        ...
        valueLookupBuilder(TwilightItemTags.SORTWOOD_LOGS_ITEM_TAG.tagKey)
        ...
        createToolSetItemTags(TwilightItems.IRONWOOD_TOOL_SET, TwilightItemTags.IRONWOOD_TOOL_MATERIALS.tagKey, listOf(TwilightItems.IRONWOOD_INGOT))
        createToolSetItemTags(TwilightItems.STEELEAF_TOOL_SET, TwilightItemTags.STEELEAF_TOOL_MATERIALS.tagKey, listOf(TwilightItems.STEELEAF_INGOT))
        createToolSetItemTags(TwilightItems.KNIGHTMETAL_TOOL_SET, TwilightItemTags.KNIGHTMETAL_TOOL_MATERIALS.tagKey, listOf(TwilightItems.KNIGHTMETAL_INGOT))
        createToolSetItemTags(TwilightItems.FIERY_TOOL_SET, TwilightItemTags.FIERY_TOOL_MATERIALS.tagKey, listOf(TwilightItems.FIERY_INGOT))

        valueLookupBuilder(TwilightItemTags.FIERY_VIALS.tagKey)
