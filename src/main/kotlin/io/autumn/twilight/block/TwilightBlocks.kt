...
import io.autumn.twilight.lists.TwilightBlockSetTypes
import io.autumn.twilight.lists.TwilightTreeGrowers
import io.autumn.twilight.lists.TwilightWoodTypes
...
object TwilightBlocks {
    ...
    val TWILIGHT_OAK_SET = WoodSet(
        Identifier.fromNamespaceAndPath(Twilight.NAMESPACE,"twilight_oak"),
        TwilightBlockSetTypes.TWILIGHT_OAK.blockSetType,
        TwilightWoodTypes.TWILIGHT_OAK.woodType,
        TwilightTreeGrowers.TWILIGHT_OAK.treeGrower,
        MapColor.WOOD,
        MapColor.PODZOL
    )
    val CANOPY_SET = WoodSet(
        Twilight.namespaceAndPath("canopy"),
        TwilightBlockSetTypes.CANOPY.blockSetType,
        TwilightWoodTypes.CANOPY.woodType,
        TwilightTreeGrowers.CANOPY.treeGrower,
        MapColor.PODZOL,
        MapColor.COLOR_BROWN
    )
    val TWILIGHT_MANGROVE_SET = WoodSet(
        Twilight.namespaceAndPath("twilight_mangrove"),
        TwilightBlockSetTypes.TWILIGHT_MANGROVE.blockSetType,
        TwilightWoodTypes.TWILIGHT_MANGROVE.woodType,
        TwilightTreeGrowers.TWILIGHT_MANGROVE.treeGrower,
        MapColor.DIRT,
        MapColor.PODZOL
    )
    val DARKWOOD_SET = WoodSet(
        Twilight.namespaceAndPath("darkwood"),
        TwilightBlockSetTypes.DARKWOOD.blockSetType,
        TwilightWoodTypes.DARKWOOD.woodType,
        TwilightTreeGrowers.DARKWOOD.treeGrower,
        MapColor.COLOR_BROWN,
        MapColor.STONE
    )
    val TIMEWOOD_SET = WoodSet(
        Twilight.namespaceAndPath("timewood"),
        TwilightBlockSetTypes.TIMEWOOD.blockSetType,
        TwilightWoodTypes.TIMEWOOD.woodType,
        TwilightTreeGrowers.TIMEWOOD.treeGrower,
        MapColor.DIRT,
        MapColor.PODZOL
    )
    val TRANSWOOD_SET = WoodSet(
        Twilight.namespaceAndPath("transwood"),
        TwilightBlockSetTypes.TRANSWOOD.blockSetType,
        TwilightWoodTypes.TRANSWOOD.woodType,
        TwilightTreeGrowers.TRANSWOOD.treeGrower,
        MapColor.WOOD,
        MapColor.PODZOL
    )
    val MINEWOOD_SET = WoodSet(
        Twilight.namespaceAndPath("minewood"),
        TwilightBlockSetTypes.MINEWOOD.blockSetType,
        TwilightWoodTypes.MINEWOOD.woodType,
        TwilightTreeGrowers.MINEWOOD.treeGrower,
        MapColor.SAND,
        MapColor.QUARTZ
    )
    val SORTWOOD_SET = WoodSet(
        Twilight.namespaceAndPath("sortwood"),
        TwilightBlockSetTypes.SORTWOOD.blockSetType,
        TwilightWoodTypes.SORTWOOD.woodType,
        TwilightTreeGrowers.SORTWOOD.treeGrower,
        MapColor.PODZOL,
        MapColor.COLOR_BROWN
    )
    ...
    val RAINBOW_OAK_SAPLING = registerGenericBlock(Twilight.namespaceAndPath("rainbow_oak_sapling"), { p -> SaplingBlock(TwilightTreeGrowers.RAINBOW_OAK.treeGrower, p) }, saplingProperties())
